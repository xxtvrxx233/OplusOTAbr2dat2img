...
def convert():
    ...
    for file in files:
        try:
            ...
            print(f"convert {file[0]} success")
        except Exception as e:
            print(f"convert {file[0]} failed：{str(e)}")
...
def delete_files():
    ...
    for file in new_dat_files:
        try:
            os.remove(file)
            print(f"Delete tmp files {file}")
        except Exception as e:
            print(f"Delete tmp files {file} failed：{str(e)}")

    print("Done.")


if contained_files:
    print("The file exists, and decompression is started....")
    run_decompress()
    convert()
    delete_files()
else:
